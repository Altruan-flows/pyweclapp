...
class Customer(Blueprint):
	...
	deliveryBlock: Union[bool, None]
	description: Union[str, None] = None
	insolvent: Union[bool, None]
	insured: Union[bool, None]
	...
	responsibleUserFixed: Union[bool, None]
	...
	useCustomsTariffNumber: Union[bool, None]
	# AutomationData
	ITEMS_NAME: ClassVar[str] = None
