...
class PartyHabitualExporterLettersOfIntent(Blueprint):
	...
	type: Union[Literal["MULTIPLE_ACCOUNTING_EVENTS", "SINGLE_ACCOUNTING_EVENT"], None] = None
	# AutomationData
	ITEMS_NAME: ClassVar[str] = None
...
class Party(Blueprint):
	...
	leadStatus: Union[Literal["CONVERTED", "DISQUALIFIED", "NEW", "PREQUALIFIED", "QUALIFIED"], None] = None
